...
# 全体通知
    ...
    tellraw @a[tag=!Difficulty.Request] [{"text":"[!] この機能はTSB-Patcherにより試験的に実装されたものです","color":"red"}]
    ...
    execute if score $Difficulty Global matches 4.. unless score $Difficulty Global matches 9 run tellraw @a[tag=!Difficulty.Request] [{"text":"現在の難易度: "},{"text":"ハード+","color":"black"}]
    execute if score $Difficulty Global matches 9 run tellraw @a[tag=!Difficulty.Request] [{"text":"現在の難易度: "},{"text":"スペランカー","color":"dark_purple"}]
    ...
    execute if score @s Believe4 matches 4.. unless score @s Believe4 matches 9 run tellraw @a[tag= Difficulty.Request] [{"text":"難易度"},{"text":"ハード+","color":"black"},{"text":"への変更申請を行いました。"}]
    execute if score @s Believe4 matches 4.. unless score @s Believe4 matches 9 run tellraw @a[tag=!Difficulty.Request] [{"text":"変更後の難易度: "},{"text":"ハード+","color":"black"}]
    execute if score @s Believe4 matches 9 run tellraw @a[tag= Difficulty.Request] [{"text":"難易度"},{"text":"スペランカー","color":"dark_purple"},{"text":"への変更申請を行いました。"}]
    execute if score @s Believe4 matches 9 run tellraw @a[tag=!Difficulty.Request] [{"text":"変更後の難易度: "},{"text":"スペランカー","color":"dark_purple"}]
