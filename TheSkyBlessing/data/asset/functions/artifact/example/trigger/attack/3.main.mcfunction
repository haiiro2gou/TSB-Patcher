...
# ダメージ
    execute store result storage api: Argument.Damage float 1.0 as @e[type=#lib:living,type=!player,tag=Victim,distance=..6,limit=1] run function api:mob/get_max_health
# ダメージ/その他の設定
