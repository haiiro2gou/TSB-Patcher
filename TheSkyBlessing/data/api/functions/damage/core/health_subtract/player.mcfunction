...
# 引数として代入
    ...
    execute if predicate api:global_vars/difficulty/min/hard store result storage api: Argument.Fluctuation double -0.0125 run scoreboard players get $Damage Temporary
