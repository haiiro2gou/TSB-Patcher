...
# 追加する
    ...
    execute store result storage oh_my_dat: _[-4][-4][-4][-4][-4][-4][-4][-4].Modifiers.Modifier.Attack.Water[-1].Amount double -0.001 run data get storage api: Argument.Amount 1000
