...
# 無ければ入れる
    execute unless data storage indexstorage: _.Modifiers.Modifier.Attack.Physical[0] run data modify storage indexstorage: _.Modifiers.Modifier.Attack.Physical set value []
# 同じUUIDのModifierを削除する
    data modify storage api: Modifiers set from storage indexstorage: _.Modifiers.Modifier.Attack.Physical
...
# 新しいModifierを追加する
    ...
    data modify storage indexstorage: _.Modifiers.Modifier.Attack.Physical set from storage api: Modifiers
# データを更新
    data modify storage api: Base set from storage indexstorage: _.Modifiers.Base.Attack.Physical
    function api:modifier/core/common/update_modifier/
    data modify storage indexstorage: _.Modifiers.Attack.Physical set from storage api: Modifier
# リセット
