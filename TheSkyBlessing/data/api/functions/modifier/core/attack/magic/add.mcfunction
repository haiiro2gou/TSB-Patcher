...
# 無ければ入れる
    execute unless data storage indexstorage: _.Modifiers.Modifier.Attack.Magic[0] run data modify storage indexstorage: _.Modifiers.Modifier.Attack.Magic set value []
