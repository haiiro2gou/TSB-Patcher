...
# 無ければ入れる
    execute unless data storage indexstorage: _.Modifiers.Modifier.Defense.Physical[0] run data modify storage indexstorage: _.Modifiers.Modifier.Defense.Physical set value []
