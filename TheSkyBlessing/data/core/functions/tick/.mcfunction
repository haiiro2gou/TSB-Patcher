...
# エンティティ前処理
    ...
    execute as @e[type=#lib:living,type=!player,tag=AlreadyInitMob] at @s run function entity:mob/tick/pre
# エンティティ本処理
    execute as @a at @s run function entity:player/tick/
    execute as @e[type=#lib:living,type=!player,tag=AlreadyInitMob] at @s run function entity:mob/tick/
# エンティティ後処理
    execute as @a at @s run function entity:player/tick/post
    execute as @e[type=#lib:living,type=!player,tag=AlreadyInitMob] at @s run function entity:mob/tick/post
