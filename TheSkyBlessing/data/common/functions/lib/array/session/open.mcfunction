...
# セッションチェック
    execute if data storage lib: {ArrayLibSessionOpened:true} run tellraw @a [{"storage":"global","nbt":"Prefix.ERROR"},{"text":"common:lib/array/のセッションが正常に閉じられていません。","color":"white"}]
# 初期化
