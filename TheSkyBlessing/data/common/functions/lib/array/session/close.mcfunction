#> common:lib/array/session/close
#
#
#
# @api
...
# セッションチェック
    execute if data storage lib: {ArrayLibSessionOpened:false} run tellraw @a [{"storage":"global","nbt":"Prefix.ERROR"},{"text":"common:lib/array/のセッションは既に閉じられています。","color":"white"}]
# リセット
