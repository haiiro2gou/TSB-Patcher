#> common:lib/array/core/compare_single
# @within function
#   common:lib/array/**compare_single
...
# 要素がまだあるなら再帰
    execute if data storage lib: CopiedArray[0] run function common:lib/array/core/compare_single