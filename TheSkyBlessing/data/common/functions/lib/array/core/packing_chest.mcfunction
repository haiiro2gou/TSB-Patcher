#> common:lib/array/core/packing_chest
#
#
#
# @within function
#   common:lib/array/core/packing_chest
#   common:lib/array/packing_chest
...
# ループ処理
    ...
    execute if score #Index Temporary < #27 Const if data storage lib: Array[0] run function common:lib/array/core/packing_chest