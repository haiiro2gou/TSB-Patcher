...
execute if score #Index Lib matches 1.. run function common:lib/array/core/move
...
execute if score #ListSize Lib matches 1.. run function common:lib/array/core/shuffle