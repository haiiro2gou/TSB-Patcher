#> common:lib/array/core/math/scalar_multiply
# @within function
#   common:lib/array/math/scalar_multiply
#   common:lib/array/core/math/scalar_multiply
...
# 計算/結果代入
    ...
    scoreboard players operation #Temp Temporary *= #Mul Temporary
...
# 要素がまだあるなら再帰
    execute if data storage lib: CopiedArray[0] run function common:lib/array/core/math/scalar_multiply