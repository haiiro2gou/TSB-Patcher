...
# データを作る
    ...
    execute if data storage asset:effect TargetEffectData.Field run data modify storage asset:effect EffectData.PrevField set from storage asset:effect TargetEffectData.Field
# イベント設定
