...
# トリガー
    ...
    execute if data storage asset:temp Trigger{Trigger:"onAttack"} run data modify storage asset:temp Temp.Trigger.B set value "攻撃"
    execute if data storage asset:temp Trigger{Trigger:"onAttackByMelee"} run data modify storage asset:temp Temp.Trigger.B set value "近接攻撃"
    execute if data storage asset:temp Trigger{Trigger:"onAttackByProjectile"} run data modify storage asset:temp Temp.Trigger.B set value "遠距離攻撃"
    ...
    execute if data storage asset:temp Trigger{Trigger:"onKilled"} run data modify storage asset:temp Temp.Trigger.B set value "撃破"
    execute if data storage asset:temp Trigger{Trigger:"onKilledByMelee"} run data modify storage asset:temp Temp.Trigger.B set value "近接攻撃で撃破"
    execute if data storage asset:temp Trigger{Trigger:"onKilledByProjectile"} run data modify storage asset:temp Temp.Trigger.B set value "遠距離攻撃で撃破"
