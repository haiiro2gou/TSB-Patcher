...
# トリガー
    ...
    execute if data storage asset:artifact Trigger{Trigger:"onAttack"} run data modify storage asset:artifact Temp.Trigger.B set value "Entityを攻撃"
    execute if data storage asset:artifact Trigger{Trigger:"onAttackByMelee"} run data modify storage asset:artifact Temp.Trigger.B set value "Entityを近接攻撃"
    execute if data storage asset:artifact Trigger{Trigger:"onAttackByProjectile"} run data modify storage asset:artifact Temp.Trigger.B set value "Entityを遠距離攻撃"
    ...
    execute if data storage asset:artifact Trigger{Trigger:"onKilled"} run data modify storage asset:artifact Temp.Trigger.B set value "Entityを殺害"
    execute if data storage asset:artifact Trigger{Trigger:"onKilledByMelee"} run data modify storage asset:artifact Temp.Trigger.B set value "Entityを近接攻撃で殺害"
    execute if data storage asset:artifact Trigger{Trigger:"onKilledByProjectile"} run data modify storage asset:artifact Temp.Trigger.B set value "Entityを遠距離攻撃で殺害"
