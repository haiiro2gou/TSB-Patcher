...
# カスタムModifierなら各自処理
    execute if score $WrongSlot Temporary matches 0 run function asset_manager:artifact/triggers/equip/modifier/custom_modifier
...
# バニラのModifierを処理
    ...
    execute if score $WrongSlot Temporary matches 0 if score $CustomModifier Temporary matches 0 run function asset_manager:artifact/triggers/equip/modifier/reshape_uuid.m with storage asset:artifact Modifier
    execute if score $WrongSlot Temporary matches 0 if score $CustomModifier Temporary matches 0 run function asset_manager:artifact/triggers/equip/modifier/generic_modifier.m with storage asset:artifact Modifier
