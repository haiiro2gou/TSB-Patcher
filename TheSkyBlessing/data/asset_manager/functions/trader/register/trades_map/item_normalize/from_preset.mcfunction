...
# プリセット読み込み
    ...
    execute if data storage asset:trader Item{PresetItem:"shard/lv-1"} run loot replace block 10000 0 10000 container.0 loot common:shard/lv-1
    execute if data storage asset:trader Item{PresetItem:"shard/lv-2"} run loot replace block 10000 0 10000 container.0 loot common:shard/lv-2
    execute if data storage asset:trader Item{PresetItem:"shard/lv-3"} run loot replace block 10000 0 10000 container.0 loot common:shard/lv-3
    execute if data storage asset:trader Item{PresetItem:"shard/lv-4"} run loot replace block 10000 0 10000 container.0 loot common:shard/lv-4
# 個数をコピーする(消えちゃうので)
