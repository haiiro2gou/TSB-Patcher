#> asset_manager:spawner/register/process_spawn_potentials/from_int_list/
#
...
function asset_manager:spawner/register/process_spawn_potentials/from_int_list/for_each