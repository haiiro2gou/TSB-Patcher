#> entity:player/api/cache/rotation
#
...
# 最新のものかチェックし、最新じゃなければ取得
    ...
    execute if score #NotLatestData Temporary matches 1 at @s as 0-0-0-0-0 run function entity:player/api/cache/rotation_fetch
# outputのstorageに移す
