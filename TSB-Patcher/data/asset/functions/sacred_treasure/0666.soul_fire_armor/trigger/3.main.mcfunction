...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0666.soul_fire_armor/trigger/2.check_condition
...
# 演出
    execute unless data storage asset:context id.all{head:664,chest:665,legs:666,feet:667} positioned ~ ~0.4 ~ facing entity @s eyes rotated ~ 0 run function asset:sacred_treasure/0664.soul_fire_armor/trigger/particle
    execute unless data storage asset:context id.all{head:664,chest:665,legs:666,feet:667} positioned ~ ~0.6 ~ facing entity @s eyes rotated ~ 0 run function asset:sacred_treasure/0664.soul_fire_armor/trigger/particle
