#> asset:sacred_treasure/0736.sailor_hat/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0736.sailor_hat/trigger/2.check_condition
...
# vfx
    execute rotated ~ 0 positioned ~ ~1.2 ~ positioned ^ ^ ^-0.5 run function asset:sacred_treasure/0736.sailor_hat/trigger/vfx
