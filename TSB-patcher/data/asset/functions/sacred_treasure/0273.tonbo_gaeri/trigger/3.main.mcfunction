#> asset:sacred_treasure/0273.tonbo_gaeri/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0273.tonbo_gaeri/trigger/2.check_condition
...
# 移動前の地点にパーティクルと音を残す
    execute at @s run function asset:sacred_treasure/0273.tonbo_gaeri/trigger/3.1.warp_effect
