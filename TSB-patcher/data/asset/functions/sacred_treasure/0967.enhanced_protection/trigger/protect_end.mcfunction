#> asset:sacred_treasure/0967.enhanced_protection/trigger/protect_end
#
#
#
# @within function asset:sacred_treasure/0967.enhanced_protection/trigger/schedule_task
