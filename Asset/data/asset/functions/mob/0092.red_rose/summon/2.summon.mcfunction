#> asset:mob/0092.red_rose/summon/2.summon
#
# Mobの召喚時の処理
#
...
# 元となるMobを召喚する
    summon zombie ~ ~ ~ {Tags:["MobInit","AlwaysInvisible","AlwaysBurn"],Silent:1b,active_effects:[{id:"fire_resistance",amplifier:0b,duration:2147483647,show_particles:0b}],DeathLootTable:"asset:mob/death/0092.red_rose"}
# ID (int)
...
# 名前 (TextComponentString) (オプション)
    data modify storage asset:mob Name set value '{"text":"赤薔薇の天使","color":"dark_red"}'
# 武器
    # メインハンド (Compound(Item)) (オプション)
        data modify storage asset:mob Weapon.Mainhand set value {id:"minecraft:stick",Count:1b,tag:{CustomModelData:314}}
