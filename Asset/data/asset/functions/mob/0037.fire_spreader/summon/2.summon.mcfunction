...
# 元となるMobを召喚する
    summon skeleton ~ ~ ~ {Silent:1b,ActiveEffects:[{id:"fire_resistance",amplifier:0b,duration:200000,show_particles:0b}],Tags:["MobInit","AlwaysInvisible"],DeathLootTable:"asset:mob/death/0037.fire_spreader",}
# ID (int)
