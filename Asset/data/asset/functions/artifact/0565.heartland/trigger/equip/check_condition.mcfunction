#> asset:artifact/0565.heartland/trigger/equip/check_condition
#
# 装備を装備した時のメイン処理
#
...
# @private
    ...
    #declare tag CanUsed
    #declare function asset:artifact/common/check_condition/feet
...
# CanUsedタグをチェックしてmain.mcfunctionを実行する
    execute as @s[tag=CanUsed] run function asset:artifact/0565.heartland/trigger/equip/main