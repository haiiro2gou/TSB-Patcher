...
# 演出
    execute if entity @s[tag=!IG.Fullset] positioned ~ ~0.4 ~ run function asset:artifact/0664.soul_fire_armor/trigger/particle2
    execute if entity @s[tag=!IG.Fullset] positioned ~ ~0.6 ~ run function asset:artifact/0664.soul_fire_armor/trigger/particle2
