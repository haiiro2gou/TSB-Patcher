#> asset:sacred_treasure/0227.onegai_muscle_4/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0227.onegai_muscle_4/trigger/2.check_condition
...
# ここから先は神器側の効果の処理を書く
    ...
    # 効果
        effect give @s resistance 30 7 true
    # 演出
