...
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0967.enhanced_protection/trigger/2.check_condition
...
execute if predicate lib:random_pass_per/30 run function asset:sacred_treasure/0967.enhanced_protection/trigger/add_mp
...
# タグ
    schedule function asset:sacred_treasure/0967.enhanced_protection/trigger/schedule_task 1t
