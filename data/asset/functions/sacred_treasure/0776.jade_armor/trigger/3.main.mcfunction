#> asset:sacred_treasure/0776.jade_armor/trigger/3.main
#
# 神器のメイン処理部
#
# @within function asset:sacred_treasure/0776.jade_armor/trigger/2.check_condition
...
# 演出
    particle dust 0.220 0.706 0.545 1 ~ ~1.3 ~ 0.4 0.2 0.4 1 50 normal
    particle rain ~ ~1.3 ~ 0.4 0.2 0.4 0 60 normal @a
